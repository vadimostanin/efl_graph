...
void DrawingContent::createDrawingLayout()
{
	...
	elm_layout_file_set( m_DrawingLayout, MAIN_EDJ, "group.graphs_layout");
	evas_object_size_hint_weight_set( m_DrawingLayout, EVAS_HINT_EXPAND, EVAS_HINT_EXPAND);
	elm_object_part_content_set( m_MainLayout, "part.main.graphs", m_DrawingLayout );
}
...
void DrawingContent::createDrawingCanvas()
{
	...
	elm_object_part_content_set( m_DrawingLayout, "part.graphs_layout.main_box", glview );
